...
<tr>
    <td valign='middle' align='center' height='0' style='padding-top: 10px; padding-bottom: 30px; border-collapse: collapse; background: $project_box_color; height: 0px; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; line-height: 1.2; color: #000; border-right: 1px #ccc solid; border-left: 1px #ccc solid; font-weight: bold;'>
        <a href='$project_dd_url' target='_blank'>
            ...
            <tr>
                <td width="300" style="padding: 0 5px 0 0; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td bgcolor="#69c6d2" style="padding: 0 5px 1px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 1 -->
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[0]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[1]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[2]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[3]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                ...
                <td width="300" style="padding: 0 0 0 5px; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td bgcolor="#deafce" style="padding: 0 5px 1px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 3 -->
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[4]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[5]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[6]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table width='121' cellpadding='0' cellspacing='0' border='0' style='border-collapse: collapse;'>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td  width='40' valign='middle' align='center' style='font-family: Tahoma, Geneva, sans-serif; font-size: 8px; color: #fff; background-color: #d3001f;'>
                                                                        <a href='<?php echo "$pd_url[7]"; ?>' target='_blank' style='padding: 8px 0px; font-size: 7px; color: #fff; text-decoration: none;'>
                                                                            BUY NOW
                                                                        </a>
                                                                    </td>
                                                                </tr>
