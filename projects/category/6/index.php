...
<tr>
<td valign="bottom" align="right" style="padding-right:35px; height: 80px; font-family: tahoma, sans-serif; font-size: 16px; line-height: 1.4; color: #000; border-collapse:collapse; background-color:#f9f9f9;  border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"><tbody>
                ...
                <?php if (!empty($project_coupon_src)) {
                    echo "
                        ...
                        <tr>
                            <td valign='top' align='left' style='padding:0;border-collapse:collapse;border-left:1px #dfdfdf solid;border-right:1px #dfdfdf solid'>
                                <a style='display:block;'  href='$project_coupon_url' target='_blank'>
