...
<?php include(__DIR__."/../../inc/view/application.php"); ?>
    ...
    <td valign='top' align='center' height='20' style='padding:0; padding-top:10px; height: 20px; font-family:Tahoma, Geneva, sans-serif; line-height: 1.4; color: #fff; border-collapse:collapse; background-color:$project_box_color;  border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid;'>
        <table width='90%'>
          ...
          <td style='width:350px; font-size: 14px; color:#ffffff; text-align:center;'>$project_dd_caption</td>
...
<tr>
    <td valign='middle' align='center' height='0' style='padding-top: 10px; padding-bottom: 5px; border-collapse: collapse; background: $project_box_color; height: 0px; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; line-height: 1.2; color: #000; border-right: 1px #ccc solid; border-left: 1px #ccc solid; font-weight: bold;'>
...
?>
        														...
        														<td width='90' height='30' valign='middle' align='center' style='padding: 0; border-collapse: collapse; width: 90px; height: 30px; background-color: #000;'>
        															<table cellspacing='0' cellpadding='0' border='0'><tbody>
        																<tr>
        																	...
        																	<td valign='middle' align='center' style='padding: 0 0 0 5px; border-collapse: collapse; font-family: Tahoma, Geneva, sans-serif; font-size: 12px; line-height: 1.0; color: #fff; font-weight: bold;'>
        																		<?php echo "$pd_dp[0]"; ?>
        																	</td>
        																</tr>
        															</tbody></table>
            ...
            <?php if (!empty($project_tnc)) {
                echo "
                    <tr>
                        <td valign='middl' align='center' style=' font-family:Tahoma, Geneva, sans-serif; height: 25px; font-size: 11px; line-height: 1.1; color: #fff; border-collapse:collapse; background-color:#730012;  border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; text-align:center;'>
                            Limited time only. Terms and conditions <a href='$project_tnc' target='_blank' style='text-decoration: underline; color: #fff;font-size: 11px;'>apply</a>.
                        </td>
                    </tr>
                ";
            }
