...
<tr>
<td valign='top' align='center' style='padding: 0; padding-top: 30px; padding-bottom: 30px; height: 20px; font-family: Tahoma, Geneva, sans-serif; line-height: 1.4; color: #fff; border-collapse: collapse; background-color: $project_box_color;  border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid;'>
    <table width='90%'>
        <tbody>
            <tr>
                ...
                <td valign='middle' style='width:350px; font-size: 24px; color:#ffffff; text-align:center; font-family: Tahoma, Geneva, sans-serif;'>
                    <strong>$project_dd_title</strong>
                </td>
                <td valign='middle' style='padding:0; height:1px; width:90px; '>
                    <hr style='border:1px solid #ffffff;;'>
        ...
        <table cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td width="300" style="padding: 0 5px 0 0; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="background: #000327; color: #fff; padding: 15px; text-align: center; font-family: 'Verdana',sans-serif; font-weight: bold; font-size: 20px"><?php echo "$b_image[2]" ?></td>
                        </tr>
                        <tr>
                            <td bgcolor="#000327" style="padding: 0 5px 5px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 1 -->
                                        <td width='150' style='background-color: #fff; padding: 10px 12px; border-right: 1px solid #000327;'>
                ...
                <td width="300" style="padding: 0 0 0 5px; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="background: #9a0034; color: #fff; padding: 15px; text-align: center; font-family: 'Verdana',sans-serif; font-weight: bold; font-size: 20px"><?php echo "$b_image[3]" ?></td>
                        </tr>
                        <tr>
                            <td bgcolor="#9a0034" style="padding: 0 5px 5px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 3 -->
                                        <td width='150' style='background-color: #fff; padding: 10px 12px; border-right: 1px solid #9a0034'>
                                            <table cellspacing='0' cellpadding='0' border='0' style='border-collapse: collapse;'>
                                                <tr>
                                                    <td>
        ...
        <table cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td width="300" style="padding: 0 5px 0 0; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="background: #003f16; color: #fff; padding: 15px; text-align: center; font-family: 'Verdana',sans-serif; font-weight: bold; font-size: 20px"><?php echo "$b_image[4]" ?></td>
                        </tr>
                        <tr>
                            <td bgcolor="#003f16" style="padding: 0 5px 5px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 5 -->
                                        <td width='150' style='background-color: #fff; padding: 10px 12px; border-right: 1px solid #003f16;'>
                                            <table cellspacing='0' cellpadding='0' border='0' style='border-collapse: collapse;'>
                                                <tr>
                                                    <td>
                ...
                <td width="300" style="padding: 0 0 0 5px; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="background: #5e2700; color: #fff; padding: 15px; text-align: center; font-family: 'Verdana',sans-serif; font-weight: bold; font-size: 20px"><?php echo "$b_image[5]" ?></td>
                        </tr>
                        <tr>
                            <td bgcolor="#5e2700" style="padding: 0 5px 5px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 7 -->
                                        <td width='150' style='background-color: #fff; padding: 10px 12px; border-right: 1px solid #5e2700'>
                                            <table cellspacing='0' cellpadding='0' border='0' style='border-collapse: collapse;'>
                                                <tr>
                                                    <td>
...
<?php if(!empty($b_image[7]) && !empty($b_url[7])) {
    echo "
        <tr>
            <td style='padding: 25px 22px 0; border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; background-color: #000;'>
                <a RILT='BottomBanner_2' href='$b_url[7]' target='_blank'>
                    <img width='606' class='ImgL' src='$project_host$b_image[7]' alt='' style='display: block;'>
                </a>
            </td>
        </tr>
    ";
}
elseif(!empty($b_image[7]) && empty($b_url[7])) {
    echo "
        <tr>
            <td style='padding: 25px 22px 0; border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; background-color: #000;'>
                <img width='606' class='ImgL' src='$project_host$b_image[7]' alt='' style='display: block;'>
...
<?php if(!empty($b_image[8]) && !empty($b_url[8])) {
    echo "
        <tr>
            <td style='padding: 25px 22px 0; border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; background-color: #000;'>
                <a RILT='BottomBanner_2' href='$b_url[8]' target='_blank'>
                    <img width='606' class='ImgL' src='$project_host$b_image[8]' alt='' style='display: block;'>
                </a>
            </td>
        </tr>
    ";
}
elseif(!empty($b_image[8]) && empty($b_url[8])) {
    echo "
        <tr>
            <td style='padding: 25px 22px 0; border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; background-color: #000;'>
                <img width='606' class='ImgL' src='$project_host$b_image[8]' alt='' style='display: block;'>
