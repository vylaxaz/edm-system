...
<tr>
    <td style="padding: 15px 19px 15px; border-left: 1px #dfdfdf solid; border-right: 1px #dfdfdf solid; background-color: <?php echo $project_box_color ?>; ">
        <!-- 4 column -->
            ...
            <tr>
                <td width="300" style="padding: 0 5px 0 0; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td bgcolor="#000327" style="padding: 0 5px 1px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 1 -->
                ...
                <td width="300" style="padding: 0 0 0 5px; width: 300px;">
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td bgcolor="#9a0034" style="padding: 0 5px 1px;">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <!-- Product 3 -->
