...
echo '<div id="main-banner" class="tab-pane">';
    ...
    $banners_sql = "SELECT * FROM `banners` WHERE `banner_id` = $current_page_id LIMIT 6,1";
...
echo '<div id="product-category" class="tab-pane">';
    $banners_sql = "SELECT * FROM `banners` WHERE `banner_id` = $current_page_id LIMIT 2,4";
    $banners_res = mysql_query ($banners_sql) or die (mysql_error());
...
echo '<div class="panel-body">
    ...
    $banners_sql = "SELECT * FROM `banners` WHERE `banner_id` = $current_page_id LIMIT 7,2";
    $banners_res = mysql_query ($banners_sql) or die (mysql_error());
